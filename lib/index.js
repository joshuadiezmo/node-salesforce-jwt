...
module.exports.getToken = function ({clientId, privateKey, userName, audience='login'}, cb) {
	var options = {
		issuer: clientId,
		audience: `https://${audience}.salesforce.com`,
		expiresInMinutes: 3,
		algorithm:'RS256'
	}
	...
	var post = {
		uri: `https://${audience}.salesforce.com/services/oauth2/token`,
		form: {
